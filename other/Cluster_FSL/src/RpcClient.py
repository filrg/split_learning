    ...
    def response_message(self, body):
        ...
        if action == "START":
            ...
            if self.layer_id == 1:
                ...
                result, size = self.train_func(self.model, self.label_count, lr, momentum, clip_grad_norm, num_layers, control_count, train_loader, config_time=config_time)

            else:
                result, size = self.train_func(self.model, self.label_count, lr, momentum, clip_grad_norm, num_layers, control_count, None)
