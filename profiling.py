...
size_KWT = [[8, 40, 98], [8, 98, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 99, 64], [8, 64]]
...
def profiling_KWT(layer_id = 1, size=8, rounds=100):
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    print(device)
